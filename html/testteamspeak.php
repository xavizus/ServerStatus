...
try{
    ...
    echo "<br/>";
    echo "<br/>";
    echo ($ts3->convertByte($ts3->connection_bytes_received_total));
    echo "<br/>";
    echo "<br/>";
    echo $ts3->convertTime($ts3->virtualserver_uptime);
} catch(\Exception $e) {
    srand(microtime());
    $hashID = sha1(rand()+microtime());
    $message = "An error have occurred: RefID: $hashID";
    echo "<script type='text/javascript'> alert('$message');</script>";
    $errorMessage = "Caught exception: ". $e->getMessage(). " RefID: $hashID";
    error_log(utf8_decode(utf8_decode($errorMessage)));
}
